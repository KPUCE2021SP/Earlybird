...
class ProfileAdapter (private val profileList : ArrayList<ProfileData>,private val itemClickedListener:(ProfileData)->Unit) : RecyclerView.Adapter<ProfileAdapter.ViewHolder>() {
...
//        holder.imgMap.image = profileData.date
    ...
    inner class ViewHolder(private val binding:ItemRecordListBinding) : RecyclerView.ViewHolder(binding.root) {
