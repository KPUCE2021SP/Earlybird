...
class ProfileAdapter (private val profileList : ArrayList<ProfileData>) : RecyclerView.Adapter<ProfileAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {     //profiledata와 뷰홀더 연결
